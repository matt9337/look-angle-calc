...
//    point = new THREE.ParticleSystem(geometry);
  ...
  addData = function(data, opts) {
    ...
    for (i = 0; i < data.length; i += step) {
      ...
      height = data[i + 2];
      height = height * GLOBE_RADIUS;
      //alert(lat+" "+lng+" "+height+" "+color+" "+subgeo);
      addPoint(lat, lng, height, color, subgeo);
  ...
  function addPoint(lat, lng, height, color, subgeo) {

    var phi = (90 - lat) * Math.PI / 180;
    var theta = (180 - lng) * Math.PI / 180;
    var r = ((1 + (height / 100.0)) * GLOBE_RADIUS);
...
//    point.scale.z = Math.max( height, 0.1 );
  ...
  function zoom(delta) {
    ...
    distanceTarget = distanceTarget > 2000 ? 750 : distanceTarget;
    distanceTarget = distanceTarget < 150 ? 750 : distanceTarget;
  }
